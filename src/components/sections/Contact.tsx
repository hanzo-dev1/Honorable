  ...
  return (
    <Section id="contact" className="text-center">
      ...
      <div className="mt-10 flex justify-center">
        <BookCallLink className="inline-flex items-center justify-center gap-2 rounded-card bg-bone px-8 py-4 font-display text-sm font-medium text-void transition-colors duration-180 ease-decisive hover:bg-white">
          Book a call
        </BookCallLink>
      </div>
